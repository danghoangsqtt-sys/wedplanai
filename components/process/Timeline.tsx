...
const Timeline: React.FC<TimelineProps> = ({ steps, selectedStepId, onSelectStep }) => {
  ...
  return (
    <div className="bg-white h-full relative z-10 border-b lg:border-b-0 lg:border-r border-rose-100 flex flex-col">
      <style>{`
      ...
      <div 
        ref={scrollRef}
        className="flex-1 overflow-x-auto lg:overflow-x-hidden lg:overflow-y-auto py-4 px-2 lg:p-0 hide-scrollbar"
      >
            ...
            return (
              <div 
                ...
                className={`
                    ...
                    min-w-[90px] sm:min-w-[120px] lg:min-w-0 lg:w-full
              ...
              >
                ...
                {!isLast && (
                   <div className="lg:hidden absolute top-4 left-1/2 w-full h-[2px] -z-10 bg-gray-100">
                      <div 
                ...
                <div 
                   className={`
                      mt-2 lg:mt-0 lg:ml-4 text-center lg:text-left transition-all duration-300 px-1 lg:px-0 flex flex-col items-center lg:items-start
