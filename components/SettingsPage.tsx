...
type SettingsTab = 'ACCOUNT' | 'DATA' | 'SYSTEM' | 'ABOUT';
                         ...
                         <div className="space-y-4">
                             ...
                             {user.allowCustomApiKey && user.isActive && (
                                <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                                   <label className="block text-sm font-bold text-gray-700 mb-2">OpenAI API Key Cá Nhân</label>
                                   <div className="relative mb-2">
                                      <input 
                                         type={showApiKey ? "text" : "password"}
                                         className={`w-full pl-10 pr-12 py-3 rounded-xl border outline-none transition-all font-mono text-sm ${
                                            !isKeyFormatValid ? 'border-red-300 focus:border-red-500 bg-red-50' : 'border-gray-300 focus:border-rose-500 focus:ring-2 focus:ring-rose-200'
                                         }`}
                                         placeholder="sk-..."
                                         value={tempApiKey}
                                   ...
                                   <div className="flex justify-between items-center mb-4">
                                      ...
                                      >
                                        Lấy Key ở đâu? <ExternalLink className="w-3 h-3" />
                                      </a>
                                   </div>
          ...
          {activeTab === 'ABOUT' && (
             <div className="p-6 md:p-8 text-center space-y-6 animate-fadeIn h-full flex flex-col justify-center items-center">
                ...
                <div className="pt-8 text-xs text-gray-400">
                   © 2024 WedPlan AI. All rights reserved.
                </div>
             </div>
          )}
